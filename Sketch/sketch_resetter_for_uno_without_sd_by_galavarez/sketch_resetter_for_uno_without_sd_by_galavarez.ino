...
int BUTTON_UP = 250;          // Пример у меня значение 132 
int BUTTON_DOWN = 450;        // Пример у меня значение 334 
int BUTTON_RIGHT = 100;       // Пример у меня значение 3 
int BUTTON_LEFT = 650;        // Пример у меня значение 482 
int BUTTON_SELECT = 850;      // Пример у меня значение 720 
