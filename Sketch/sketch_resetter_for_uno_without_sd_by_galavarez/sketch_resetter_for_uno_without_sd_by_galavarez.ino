...
/*
// 24С01_02 // Ricoh SP 110E 2K (XXXXXX) for Ricoh SP 111 (SF/SU)
const PROGMEM byte dump_ricoh_sp_110e_xxxxxx[128] = {
...
const PROGMEM byte dump_ricoh_sp_c250_c260_407544_cyan[128] = {
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x64, 0x00, 0x34, 0x30, 0x37, 0x35, 0x34, 0x34, 
...
void database(byte id)
{
  ...
  global_all_chip_in_database = 24; 
