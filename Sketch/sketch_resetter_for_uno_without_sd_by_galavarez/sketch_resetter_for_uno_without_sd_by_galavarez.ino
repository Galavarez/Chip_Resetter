...
// 24С04_16 // Xerox 3220 11K for Xerox Phaser 3320 (MLT-D305) 
const PROGMEM byte dump_xerox_3220[512] = {
  ...
  ,
...
{  
  ...
  else if (analog_number < 300 && global_button_press == false) // Если это кнопка UP и другие кнопки не нажаты то
  {
    if (analog_debonce(300) == true) // делаем проверку от дребезга кнопок
    {
  ...
  else if (analog_number < 500 && global_button_press == false) // Если это кнопка Down и другие кнопки не нажаты то
  {
    if (analog_debonce(500) == true) // делаем проверку от дребезга кнопок
    {
  ...
  else if (analog_number < 700 && global_button_press == false) // Если это кнопка Left и другие кнопки не нажаты то
  {
    if (analog_debonce(700) == true) // делаем проверку от дребезга кнопок
    {
  ...
  else if (analog_number < 900 && global_button_press == false) // Если это кнопка Select и другие кнопки не нажаты то
  {
    if (analog_debonce(900) == true)  // делаем проверку от дребезга кнопок
    {
...
void database(byte id)
{
  ...
  global_all_chip_in_database = 28; 
